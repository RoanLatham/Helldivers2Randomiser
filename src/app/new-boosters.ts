...
export const boostersByWarbond: { [warbond: string]: Booster[] } = {
  'Steeled_Veterans': boosters.filter(booster => booster.warbond === 'Steeled_Veterans'),
  'Freedoms_Flame': boosters.filter(booster => booster.warbond === 'Freedoms_Flame'),
  'Truth_Enforcers': boosters.filter(booster => booster.warbond === 'Truth_Enforcers'),
  'Cutting_Edge': boosters.filter(booster => booster.warbond === 'Cutting_Edge'),
  'Viper_Commandos': boosters.filter(booster => booster.warbond === 'Viper_Commandos'),
  'Urban_Legends': boosters.filter(booster => booster.warbond === 'Urban_Legends'),
  'Democratic_Detonation': boosters.filter(booster => booster.warbond === 'Democratic_Detonation'),
  'Helldivers_Mobilize': boosters.filter(booster => booster.warbond === 'Helldivers_Mobilize'),
  'Polar_Patriots': boosters.filter(booster => booster.warbond === 'Polar_Patriots'),
};
